...
<html lang="en">
  ...
  <body>    
        <div class="jumbotron jumbotron-fluid" style="background-color:rgb(88, 235, 235);">        
...
<html lang="en">
  ...
  <body>
        ...
        <div class="jumbotron jumbotron-fluid" style="background-color:rgb(231, 74, 74); ">
...
![output](./static/img/pred.png)
![output](./static/img/train.png)

## CODE VALIDATOR:

![output](./static/img/predval.png)
![output](./static/img/trainval.png)


## RESULT:
        
Thus a website is designed to train the house price model and to predict the price and is hosted in the URL http://loki.student.saveetha.in:8000/HouseModelTraining/ and http://loki.student.saveetha.in:8000/HouseModelPrediction/ HTML code is validated.
